...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-600/[0.08] via-transparent to-primary-400/[0.05] blur-3xl" />
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    height={40}
                    rotate={-25}
                    gradient="from-primary-300/[0.10]"
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <Circle className="h-2 w-2 fill-primary-500/80" />
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-primary-400 via-white/90 to-primary-300"
                                )}
                            >
                                {title2}
                            </span>
